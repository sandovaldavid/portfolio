...
describe('current project evidence contracts', () => {
	...
	it('describes Campus Map as the shipped Next.js 16 directory while keeping mapping on the roadmap', () => {
	...
	it('keeps canonical project boundaries aligned in Spanish without requiring translation parity', () => {
		...
		expect(auctions).toContain('LOS EXPERIMENTOS REST Y WEBSOCKET ESTÁN FUERA DEL FLUJO ACTUAL');
	});
});
