	...
	for (const locale of [
		{
			...
			tradeoffs: 'LOCAL-FIRST BY DEFAULT',
			outcome: 'PUBLISHED V3 WORKFLOW AND HANDOFF CONTRACT',
			evidence: 'Evidence and limitations',
			verified: 'PUBLIC RELEASES, CONTRACTS AND OPERATIONAL DOCS',
			boundaries: 'RELEASED VS. DEVELOP STAYS EXPLICIT',
		...
		},
		{
			...
			tradeoffs: 'LOCAL-FIRST POR DEFECTO',
			outcome: 'WORKFLOW V3 Y CONTRATO DE TRASPASO PUBLICADOS',
			evidence: 'Evidencia y limitaciones',
			verified: 'RELEASES, CONTRATOS Y DOCUMENTACIÓN OPERATIVA PÚBLICOS',
			boundaries: 'RELEASE Y DEVELOP PERMANECEN EXPLÍCITOS',
