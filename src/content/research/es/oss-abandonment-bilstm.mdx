...
<ResearchSection eyebrow="Características de ingeniería">
...
<EvaluationCriteria
  ...
  items={[
    { label: 'ACC', detail: 'Accuracy de clasificación vs. baselines Logistic Regression y Random Forest' },
    ...
    { label: 'LOSS', detail: 'Curvas de Binary Cross-Entropy para convergencia del entrenamiento BiLSTM' },
  ]}
/>
