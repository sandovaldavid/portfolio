...
El baseline está restringido a datos abiertos. **npm es el primer ecosistema para validar factibilidad**, no una afirmación de que la tesis deba quedar limitada a npm. El piloto comprueba si episodios de dependencias vulnerables, oportunidades de remediación y features disponibles en el momento de observación pueden reconstruirse con consistencia suficiente para un estudio prospectivo.
