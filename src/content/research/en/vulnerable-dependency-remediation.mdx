...
The baseline is restricted to open data. **npm is the first feasibility ecosystem**, not a claim that the thesis must remain npm-only. The pilot is testing whether vulnerable-dependency episodes, remediation opportunities and observation-time features can be reconstructed consistently enough for a prospective study.
