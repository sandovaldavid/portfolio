...
<ResearchSection eyebrow="Engineered features">
...
<ResearchSection eyebrow="Model architecture">
...
<EvaluationCriteria
  ...
  items={[
    { label: 'ACC', detail: 'Classification accuracy vs. Logistic Regression & Random Forest baselines' },
    { label: 'F1', detail: 'F1-Score on imbalanced abandonment classes' },
    { label: 'AUC', detail: 'AUC-ROC for abandonment probability ranking' },
    { label: 'LOSS', detail: 'Binary Cross-Entropy loss curves for BiLSTM training convergence' },
  ]}
/>

<ResearchSection eyebrow="Current status">
