...
<CaseStudySection
	...
	title="V1 remains a private beta"
	surface="highlight"
>
	<EvidenceBlock
		label="PRODUCT STATUS"
		title="PRIVATE BETA · ACTIVE DEVELOPMENT"
		tone="boundary"
	>
		The code remains private. Current work is focused on authorization, financial consistency,
		persistence, exports, privacy and clean-stack acceptance before real household financial data
		is in scope.
	</EvidenceBlock>
</CaseStudySection>
