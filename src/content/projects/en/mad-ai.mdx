...
<CaseStudySection eyebrow="CURRENT IMPLEMENTATION" title="Responsibilities remain explicit across client and API">
  <CaseStudyGrid columns={2}>
    ...
    <EvidenceBlock label="ACTIVE BOUNDARY" title="REQUEST/RESPONSE REST IS THE CURRENT TRANSPORT" tone="boundary">
    ...
    <EvidenceBlock label="DELIVERY BOUNDARY" title="CLIENT AND API CAN EVOLVE INDEPENDENTLY" tone="boundary">
