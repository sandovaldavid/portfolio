...
<CaseStudySection eyebrow="CURRENT STACK" title="Next.js 16, React 19 and Tailwind 4" surface="highlight">
  <CaseStudyGrid columns={2}>
    <EvidenceBlock label="IMPLEMENTATION" title="NEXT.JS 16 · REACT 19 · TAILWIND 4" tone="verified">
...
<CaseStudySection eyebrow="LEARNINGS" title="What the project reinforced">
  <CaseStudyGrid columns={3}>
    ...
    <CaseStudyCard label="LEARNING 02" title="KEEP CONFIGURATION AND DOCUMENTATION ALIGNED" tone="success">
