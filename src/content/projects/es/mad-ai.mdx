...
<CaseStudySection eyebrow="FRONTEND" title="Las capas corresponden a límites reales dentro de Angular">
...
<CaseStudySection eyebrow="IMPLEMENTACIÓN ACTUAL" title="Las responsabilidades permanecen explícitas entre cliente y API">
  <CaseStudyGrid columns={2}>
    ...
    <EvidenceBlock label="LÍMITE ACTIVO" title="REST REQUEST/RESPONSE ES EL TRANSPORTE ACTUAL" tone="boundary">
    ...
    <EvidenceBlock label="LÍMITE DE ENTREGA" title="CLIENTE Y API PUEDEN EVOLUCIONAR POR SEPARADO" tone="boundary">
...
<CaseStudySection eyebrow="APRENDIZAJES" title="Qué reforzó el diseño en dos repositorios" surface="highlight">
  <CaseStudyGrid columns={3}>
    <CaseStudyCard label="APRENDIZAJE 01" title="LA ARQUITECTURA DEL CLIENTE TAMBIÉN PUEDE TENER LÍMITES REALES" tone="success">
    ...
    <CaseStudyCard label="APRENDIZAJE 02" title="LOS LÍMITES LIMPIOS PUEDEN SER PRAGMÁTICOS CON EL FRAMEWORK" tone="success">
    ...
    <CaseStudyCard label="APRENDIZAJE 03" title="LOS LÍMITES DE REPOSITORIO DEBEN REFLEJAR LOS DEL SISTEMA" tone="success">
