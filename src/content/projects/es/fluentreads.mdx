...
<CaseStudySection eyebrow="LÍMITE DEL PRODUCTO" title="La tienda mantiene acotadas sus responsabilidades comerciales">
...
<CaseStudySection eyebrow="SISTEMA" title="Contenido estático, estado del navegador y cierre externo permanecen separados" surface="highlight">
	<MermaidDiagram
...
<CaseStudySection eyebrow="ESTADO DEL CLIENTE" title="El comportamiento del carrito es explícito y recuperable" surface="highlight">
  <CaseStudyGrid columns={3}>
    ...
    <CaseStudyCard label="EVENTOS" title="CARTUPDATED DESACOPLA LA ACTUALIZACIÓN DE LA UI" tone="primary">
    ...
    <CaseStudyCard label="CIERRE DEL PEDIDO" title="WHATSAPP ES EL SIGUIENTE PASO DEL PROCESO" tone="primary">
...
<CaseStudySection eyebrow="IMPLEMENTACIÓN ACTUAL" title="Qué contiene hoy la tienda" surface="highlight">
  <CaseStudyGrid columns={2}>
    ...
    <EvidenceBlock label="ALCANCE DEL PRODUCTO" title="SIN BASE DE DATOS, AUTENTICACIÓN NI PASARELA DE PAGO ONLINE" tone="boundary">
...
<CaseStudySection eyebrow="APRENDIZAJES" title="Qué reforzó este proyecto">
  <CaseStudyGrid columns={3}>
    ...
    <CaseStudyCard label="APRENDIZAJE 03" title="LA AUTORÍA DE CONTENIDO ES UNA DECISIÓN ARQUITECTÓNICA" tone="success">
